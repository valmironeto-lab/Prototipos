...
class BSM_Admin {
	...
	private function load_dependencies() {
		...
		$pages_to_load = ['dashboard', 'campaigns', 'contacts', 'lists', 'import', 'reports', 'settings', 'logs', 'templates', 'forms', 'automations', 'tags'];
	...
	private function instantiate_classes() {
		...
		foreach ( $page_classes as $slug => $class_name ) {
			if ( class_exists( $class_name ) ) { $pages[ $slug ] = new $class_name( $this->plugin ); }
		}
